...
INSERT INTO `kullanici` (`id`, `eposta`, `sifre`, `isim`, `yas`, `adres`) VALUES
(1, 'x@xx.x', 'xx', 'xisim', 18, 'x sokak'),
(2, 'y@yy.y', 'yy', 'yisim', 20, 'y sokak'),
(3, 'z@zz.z', 'zz', 'zisim', 50, 'z  sokak'),
(4, 'eposta', 'sifre', 'isim', 15, 'eposta sokak'),
(5, 'eposta1', 'sifre', 'isim', 15, 'eposta1 sokak'),
(6, 'aa@a.a', 'aa', 'aaa', 25, 'a sokak');
...
INSERT INTO `liste` (`listeid`, `kid`, `satid`, `liste`) VALUES
(1, 4, 2, 'sepet'),
(2, 4, 1, 'sepet');
...
--
ALTER TABLE `liste`
  ADD CONSTRAINT `liste_ibfk_1` FOREIGN KEY (`kid`) REFERENCES `kullanici` (`id`),
  ADD CONSTRAINT `liste_ibfk_2` FOREIGN KEY (`satid`) REFERENCES `satis` (`satisid`);
